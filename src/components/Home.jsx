    ...
    return (
        <div className="w-full h-screen bg-[#0a192f] z-10 px-8 sm:px-0">
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                ...
                <div className="parallelogram-top my-2 md:w-[800px] w-[400px] h-[45px] sm:w-[625px] sm:h-[70px] md:h-[85px] z-10"><h2 className="text-4xl sm:text-6xl md:text-7xl sm:h-[65px] pt-1 sm:pr-0 pr-3 text-[#333333] font-bold title-name text-center z-10">CS Student @ UT Austin</h2></div>
