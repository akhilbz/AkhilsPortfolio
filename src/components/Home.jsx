    ...
    return (
        ...
        <div name="home" className="w-screen h-screen bg-[#121212] z-10 px-8 sm:px-0 flex justify-center">
            <div className="w-fit lg:mx-auto sm:ml-9 ml-0 px-4 flex flex-col justify-center h-[750px] ">
                ...
                <svg className="blob-motion2 overflow-hidden" id="visual" viewBox="0 0 1000 700" width="850" height="700" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
                ...
                <svg className="blob-motion3" id="visual" viewBox="0 0 420 470" width="420" height="470" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
