...
const Home = () => {
    return (
        ...
        <div name="home" className="w-full h-screen bg-[#121212] z-10 px-8 sm:px-0 ">
            <div className="max-w-[1000px] lg:mx-auto sm:ml-9 mx-auto ml-0 px-8 flex flex-col justify-center h-[750px] ">
                <div className="flex ">
                ...
                <h1 className="text-5xl sm:text-6xl md:text-7xl text-white font-semibold title-name">Akhilesh Bitla</h1>
                <div className="parallelogram-top my-2 lg:w-[800px] md:w-[700px] w-[350px] h-[45px] sm:w-[600px] sm:h-[60px] lg:h-[85px] z-10 overflow-hidden"><h2 className="text-3xl sm:text-5xl lg:text-7xl sm:h-[65px] pt-1 sm:pr-0 md:pr-3 text-[#333333] font-bold title-name text-center z-10">CS Student @ UT Austin</h2></div>
