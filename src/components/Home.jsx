    ...
    return (
        ...
        <div name="home" className="w-screen h-screen bg-[#121212] z-10 px-8 sm:px-0 flex justify-center">
            <div className="w-fit lg:mx-auto sm:ml-9 ml-0 px-4 flex flex-col justify-center h-[750px] ">
                ...
                <svg className="blob-motion3" id="visual" viewBox="0 0 500 500" width="500" height="500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
                    <g transform="translate(266.8402355767408 262.97648182153057)"><path id="blob5" d="M127.6 -166.7C153.3 -130.6 153.6 -78.9 161.3 -29.3C169 20.2 184.1 67.6 171.4 107.9C158.8 148.1 118.4 181.2 74.6 191C30.9 200.8 -16.2 187.3 -65.3 172.4C-114.4 157.6 -165.4 141.3 -190.3 106.1C-215.2 70.8 -214 16.7 -200.4 -31C-186.8 -78.6 -160.9 -119.7 -125.4 -154.2C-90 -188.6 -45 -216.3 3 -219.9C51 -223.4 102 -202.9 127.6 -166.7" fill="#212020"></path></g>
                    <g transform="translate(245.14127353314478 261.6633657945255)" style={{visibility: "hidden"}}><path id="blob6" d="M146.5 -166.5C185.9 -141.6 211.1 -91.6 216.5 -41.1C221.9 9.4 207.5 60.4 177.4 92.9C147.3 125.4 101.5 139.3 58.8 149.8C16 160.4 -23.8 167.6 -66.7 161.5C-109.7 155.4 -155.7 135.9 -182.2 100.3C-208.7 64.6 -215.6 12.7 -198.7 -26.7C-181.9 -66.1 -141.2 -92.9 -104.1 -118.2C-67 -143.5 -33.5 -167.2 10 -179.2C53.6 -191.2 107.1 -191.3 146.5 -166.5" fill="#212020"></path></g>
                </svg>
                </section>
            </div>
        </div>
