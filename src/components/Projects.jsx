      ...
      <div className="h-[fit-content] pb-[300px]">
        ...
        <div className="flex-col mt-[90px] ">
          <div className="lg:flex-row flex-col flex lg:justify-between justify-center items-center lg:mr-8 lg:ml-[80px]">
            ...
            <div className="w-[400px] h-[400px] bg-[#140021] flex-col flex justify-center lg:py-9 items-center rounded hover:scale-105 duration-500 ">
          ...
          <div className="lg:flex-row flex-col flex lg:justify-between justify-center items-center lg:mr-8 lg:ml-[80px] mt-[50px] sm:mt-7">
            <div className="w-[400px] h-[400px]  bg-[#140021] flex-col flex justify-center lg:py-9 items-center rounded hover:scale-105 duration-500">
