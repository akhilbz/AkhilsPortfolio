...
const Footer = () => {
  return (
    <div className='w-full xl:h-[500px] md:h-[650px] h-[1000px] bg-[#121212] flex xl:justify-between justify-center items-center'>
         <div className="lg:ml-[80px] rounded-2xl xl:flex-row flex-col justify-between flex">
            <div className="h-full">
                <h1 className='text-3xl sm:text-5xl text-white font-normal flex sm:justify-start justify-center p-2 mt-5'>Interested in my work?</h1>
                <div className='flex p-1 justify-between md:flex-row flex-col'>
                    <div className="flex-col">
                        ...
                        <div className="xl:hidden flex justify-center items-end w-full h-fit md:justify-start xl:pr-4 pl-1">
                    ...
                    <div className="flex flex-col justify-end w-full p-4 h-[fit-content] items-center  ">
                        ...
                        <div className="xl:hidden flex flex-col w-fit h-full pt-[35px]">
                            <div className="flex-col w-full text-white">
                                ...
                                <a href="https://drive.google.com/file/d/1DAV8-95-OaOxHt1F0ZrD1MPuPKpyZARY/view?usp=sharing" target="_blank">
            ...
            <div className="xl:flex hidden justify-start w-fit h-fit md:justify-start xl:pr-4 pl-1">
