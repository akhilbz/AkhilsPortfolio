...
const Education = () => {
    ...
    return (
        <>
        <div name="education"  className="w-full h-full sm:flex bg-[#F7E3B6] flex pt-[100px] xl:flex-row flex-col ">
            ...
            <div className="w-[fit-content] h-[fit-content] flex justify-start items-center flex-col sm:pt-3 pt-1">
                <div className="flex-col flex xl:items-end ">
                    ...
                    <h3 className='text-2xl sm:text-3xl font-bold xl:justify-end justify-center flex text-[#333333] cns-edu-title '> College of Natural Sciences</h3>
                    </div>
                    <div className="flex-col lg:my-[40px] my-5 rounded-2xl w-[fit-content] mx-[30px] md:mx-[150px] lg:mx-[75px] py-2 text-black">
        ...
        <div className="w-full h-full flex flex-col justify-center items-center bg-[#F7E3B6] pt-[140px]">
            ...
            <div className="mt-2 w-[fit-content] md:w-full flex-col lg:flex-row flex lg:items-start items-center ">
                <div className="flex lg:ml-[70px] lg:flex-col flex-row justify-center items-start w-[fit-content]">
                    ...
                    <div className="hover:scale-95 duration-500 flex bg-[#333333] rounded-2xl md:w-[250px] md:h-[250px] w-[200px] h-[200px] items-center ml-2 lg:ml-[0px]" style={{ boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.75)' }}>
