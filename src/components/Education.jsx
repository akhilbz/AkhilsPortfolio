        ...
        <div name="education"  className="w-full h-full sm:flex bg-[#333333] flex pt-[100px] xl:flex-row flex-col ">
            ...
            <div className="w-[fit-content] h-[fit-content] flex justify-start items-center flex-col sm:pt-3 pt-1">
                <div className="flex-col flex xl:items-end ">
                    ...
                    Participating in my first hackathon at HackTX 2022, my team won the <span className='text-white font-semibold'>"Best Overall on a Beginners' Track Award."</span> This year, I plan to participate in either <span className=''>Texas Momentum</span> or <span className=''>Texas Convergent</span>, <span className=''>Texas Luminescence</span>, and <span className=''>FreeTail Hacker's Hackathons</span>. 
        ...
        <div className="w-full h-full flex flex-col justify-center items-center bg-[#333333] md:pt-[40px] pt-[20px]">
            ...
            <div className="mt-2 w-[fit-content] md:w-full flex-col lg:flex-row flex lg:items-start items-center ">
                ...
                <div className="flex-col xl:flex-row xl:flex sm:justify-start justify-center sm:items-start items-center sm:ml-3 ">
                    ...
                    <p>Over the summer, I completed the rigorous <span className='text-[#FFA86E] font-semibold'>Entrepreneurship Minor</span> at <span className='text-[#FFA86E] font-semibold'>McCombs School of Business</span> by pursuing the enriching  <span className='text-white font-semibold'>Summer Entrepreneurship Academy (SEA)</span>.</p>
                    ...
                    Over eight weeks, I engaged in four of five essential classes, honing skills such as <span className='text-white font-semibold'>effective pitching</span>,
                     <span className='text-white font-semibold'>innovative thinking</span>, <span className='text-white font-semibold'>market validation</span>, and <span className='text-white font-semibold'>business model creation</span>.</p> 
                    ...
                    <p className='pt-3'>This transformative experience allowed me to expand upon the key traits needed to become a <span className='text-white font-semibold'>successful entrepreneur</span> and form meaningful connections with extraordinary students from diverse backgrounds.
                        SEA has been a <span className='text-white font-[Anton] text-2xl' style={{ position: 'relative', top: '3px' }}>pivotal chapter</span> in my academic journey, and I aim to use the skills I learned in every aspect of my career.</p>
                    </div>
                </div>
