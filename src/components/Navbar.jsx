            ...
            <h1 className='font-[Megrim] text-3xl text-white'>AKHILESH BITLA</h1>
                <ul className='items-center justify-center flex flex-col text-white'>
                    ...
                    <div className="flex w-[50%] justify-between py-5">
                        ...
                        <a href="https://drive.google.com/file/d/19VygPMZQTgWMix3Dli4C5U0n1jIF-isH/view?usp=sharing" target="_blank"><BiFile size={30} className='cursor-pointer text-[#FFA86E]'/></a>
                    </div>
                </ul>
            </div>
            {/** Socials */}
            <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul>
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] hover:rounded-tr-2xl duration-300 bg-[#F7760E] rounded-br-2xl'>
                        <a href="https://drive.google.com/file/d/19VygPMZQTgWMix3Dli4C5U0n1jIF-isH/view?usp=sharing" target="_blank" className='w-[160px] h-[60px] flex font-semibold justify-between items-center text-white'>
